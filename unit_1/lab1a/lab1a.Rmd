...
- **(11) Which one of these plots would be useful for answering the question: _Is it unusual for students in the CDC dataset to be taller than 1.8 meters?_**
...
- **(12) Do you think it's unusual for students in the data to be taller than 1.8 meters? Why or why not?**
...
- After completing the lab, answer the following questions:
    ...
    - <font color=#25679E><b>(16) Write the code to visualize the distribution of weights of the students in the CDC data with a `histogram`.</b></font> **What is the _typical_ weight?**
    - <font color=#25679E><b>(17) Write the code to create a `bargraph` to visualize the distribution of how often students ate fruit.</b></font> **About how many students did not eat fruit over the previous 7 days?**
