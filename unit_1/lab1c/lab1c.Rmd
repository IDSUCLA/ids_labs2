...
- Click on the option labeled <font color="green">Export Data</font>.
...
- Click the button on the Files pane that says "Upload".
  - Click on "Choose File" and find the _SurveyResponses.csv_ file you saved to your computer.
  - Hit the _OK_ button.
- Voila!
...
- On the Files pane, find the data you want to <font color="green">Import</font>.
...
- <span class="blue">(1) `View` your data, then select a variable and try to make an appropriate plot for that variable.</span>